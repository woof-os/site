...
cp ~/.config/dunst/$NEWTHEME ~/.config/dunst/dunstrc ||  mv ~/.config/dunst/dunstrc.bak ~/.config/dunst/dunstrc

mv ~/.config/qtile/config/colors.json ~/.config/qtile/config/colors.json.bak
cp ~/.config/qtile/config/$NEWTHEME.json ~/.config/qtile/config/colors.json || mv ~/.config/qtile/config/colors.json.bak ~/.config/qtile/config/colors.json

[ ! -d ~/.config/starship ] && mkdir -p ~/.config/starship 
mv ~/.config/starship.toml ~/.config/starship/starship.toml.bak
cp ~/.config/starship/$NEWTHEME.toml ~/.config/starship.toml || mv ~/.config/starship.toml.bak ~/.config/starship/starship.toml

mv ~/.config/zathura/zathurarc ~/.config/zathura/zathurarc.bak
cp ~/.config/zathura/$NEWTHEME ~/.config/zathura/zathurarc || mv ~/.config/zathura/zathurarc.bak ~/.config/zathura/zathurarc
